#!/usr/bin/env python3
# CLI directly called by running the SpeakerAuth command
...
# Basic command setup
parser = argparse.ArgumentParser(description="Command line interface for SpeakerAuth face authentication.",
                                 formatter_class=argparse.RawDescriptionHelpFormatter,
                                 add_help=False,
                                 prog="SpeakerAuth",
                                 epilog="For support please visit\nhttps://github.com/jiapulidoar/SpeakerAuthentication")
...
parser.add_argument("-I", "--uid",
                    default=uid,
                    help="Set the uid account to use.")
...
if args.user == "root":
	print("Can't run SpeakerAuth commands as root, please run this command with the --user flag")
	sys.exit(1)
